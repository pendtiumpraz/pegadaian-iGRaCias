...
export default function RegulasiCreate() {
    ...
    return (
        <AppLayout title="Tambah Regulasi">
            <PageHeader
                title="Tambah Regulasi"
                description="Daftarkan regulasi atau peraturan yang relevan bagi organisasi."
                breadcrumbs={[
            ...
            <div style={{ padding: '20px 32px' }}>
                <form onSubmit={submit}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                            <div style={grid2}>
                                <Field label="Nomor Regulasi" error={errors.nomor_regulasi}>
                                    <input
                                        ...
                                        placeholder="POJK No. 11/POJK.03/2016"
                                    />
                                </Field>
                                <Field label="Penerbit" error={errors.penerbit}>
                                    <input
                                        ...
                                        placeholder="OJK / Bank Indonesia / Pemerintah RI"
                                    />
                                </Field>
                            </div>
                            ...
                            <Field label="Judul Regulasi" error={errors.judul}>
                                <input
                                    ...
                                    placeholder="Judul lengkap regulasi"
                                />
                            </Field>
                            ...
                            <Field label="URL Sumber (opsional)" error={errors.url_sumber}>
                                <input
                                    ...
                                    placeholder="https://www.ojk.go.id/..."
                                />
                            </Field>
                        </div>
                    </div>
                    ...
                    <div style={cardStyle}>
                        ...
                        <Field label="Ringkasan Regulasi" error={errors.ringkasan}>
                            <textarea
                                ...
                                placeholder="Tuliskan ringkasan singkat isi dan ketentuan utama regulasi ini…"
                            />
                        </Field>
                    </div>
                    ...
                    >
                        ...
                        >
                            {processing ? 'Menyimpan…' : 'Simpan Regulasi'}
                        </button>
                    </div>
                </form>
            </div>
